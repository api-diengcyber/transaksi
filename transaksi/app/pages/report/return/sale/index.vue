...
// --- LOAD TRANSAKSI RETURN PENJUALAN ---
const loadData = async () => {
    ...
    try {
        ...
        toast.add({ severity: 'error', summary: 'Error', detail: 'Gagal memuat Laporan Return Penjualan', life: 3000 });
        returns.value = [];
    } finally {
        loading.value = false;
    }
    ...
    <div class="min-h-screen flex flex-col bg-surface-50 p-4 md:p-6 font-sans">
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-surface-500 mt-1">Pantau rincian barang yang dikembalikan oleh pelanggan.</p>
            </div>
            ...
            <div class="p-4 border-b border-surface-100 flex flex-col xl:flex-row justify-between items-center gap-4 bg-surface-0/50">
                <div class="flex flex-col sm:flex-row items-center gap-3 w-full xl:w-auto">
                    <div class="relative w-full sm:w-72">
                        ...
                        <input v-model="searchQuery" @input="onSearch" type="text" placeholder="Cari Retur/Invoice/Member..." class="w-full pl-10 pr-4 py-2 border border-surface-200 rounded-xl text-sm focus:ring-orange-500 focus:border-orange-500 transition-colors" />
                    </div>
            ...
            >
                <template #empty>
                    <div class="flex flex-col items-center justify-center py-16 px-4 text-surface-500">
                        ...
                        <p class="text-sm mt-1 max-w-sm text-center">Data return penjualan belum tersedia atau tidak ditemukan.</p>
                    </div>
                </template>
