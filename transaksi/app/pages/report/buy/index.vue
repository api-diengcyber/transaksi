    ...
    <div class="min-h-screen flex flex-col bg-surface-50 p-4 md:p-6 font-sans">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-surface-200 flex items-center gap-4 border-l-4 border-l-indigo-500">
                <div class="w-12 h-12 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-500 shrink-0"><i class="pi pi-money-bill text-xl"></i></div>
            ...
            <div class="p-4 border-b border-surface-100 flex flex-col xl:flex-row justify-between items-center gap-4 bg-surface-0/50">
                <div class="flex flex-col sm:flex-row items-center gap-3 w-full xl:w-auto">
                    <div class="relative w-full sm:w-72">
                        ...
                        <input v-model="searchQuery" @input="onSearch" type="text" placeholder="Cari Faktur atau Supplier..." class="w-full pl-10 pr-4 py-2 border border-surface-200 rounded-xl text-sm focus:ring-indigo-500 focus:border-indigo-500 transition-colors" />
                    </div>
                ...
                <Column field="code" header="No Faktur / Transaksi" sortable style="min-width: 14rem">
                    <template #body="{ data }">
                        <div class="flex flex-col gap-1 py-1">
                            <div class="font-bold font-mono text-indigo-700 bg-indigo-50 px-2 py-0.5 rounded-md inline-block w-max border border-indigo-100 shadow-sm" v-tooltip.top="'Nomor Faktur / Invoice'">
