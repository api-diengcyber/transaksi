...
<template>
    <div class="flex flex-col h-full bg-surface-50 transition-colors duration-300">
        ...
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl font-bold  tracking-tight">Laporan Piutang (AR)</h1>
            <p class="text-surface-500  mt-1 text-sm">Monitoring tagihan pelanggan, jatuh tempo, dan riwayat pembayaran.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
            ...
            <div class="p-5 rounded-2xl bg-surface-0 shadow-sm border border-surface-200  relative overflow-hidden group hover:shadow-md transition-all">
                ...
                <div class="flex justify-between items-start mb-4 relative z-10">
                    <div>
                        <p class="text-surface-500  text-xs font-bold uppercase tracking-widest mb-1">Total Tagihan</p>
                ...
                <p class="text-xs text-surface-500 ">Akumulasi seluruh nota kredit</p>
            </div>
            ...
            <div class="p-5 rounded-2xl bg-surface-0 shadow-sm border border-surface-200  relative overflow-hidden group hover:shadow-md transition-all">
                ...
                <p class="text-xs text-surface-500 ">Tagihan selesai dibayar</p>
            </div>
            ...
            <div class="p-5 rounded-2xl bg-surface-0 shadow-sm border border-surface-200  relative overflow-hidden group hover:shadow-md transition-all">
                ...
                <p class="text-xs text-surface-500 ">Menunggu pembayaran</p>
            </div>

             <div class="p-5 rounded-2xl bg-emerald-50 shadow-sm border border-emerald-200 relative overflow-hidden group hover:shadow-md transition-all">
                ...
                <div class="flex justify-between items-start mb-4 relative z-10">
                    <div>
                        <p class="text-emerald-700 text-xs font-bold uppercase tracking-widest mb-1">Sisa Piutang (Balance)</p>
                        <h3 class="text-2xl font-black text-emerald-800">{{ formatCurrency(stats.totalSisa) }}</h3>
                    </div>
                    <div class="bg-surface-0/50 /50 p-2.5 rounded-xl text-emerald-700  shadow-sm">
                        <i class="pi pi-chart-pie text-xl"></i>
                    </div>
                </div>
                <p class="text-xs text-emerald-700/70 font-medium">Uang yang harus ditagih</p>
            </div>
        </div>
                ...
                <Column field="code" header="Info Nota" sortable>
                    <template #body="slotProps">
                        <div class="flex flex-col py-1">
                            <span class="font-bold font-mono text-sm tracking-tight text-emerald-700 ">{{ slotProps.data.code }}</span>
                ...
                <Column field="contact" header="Pelanggan" sortable>
                    <template #body="slotProps">
                         <div class="flex items-center gap-2">
                            <Avatar :label="slotProps.data.contact ? slotProps.data.contact.charAt(0).toUpperCase() : 'U'" shape="circle" size="small" class="!bg-surface-200  !text-surface-600  !text-xs" />
                 ...
                 <Column field="remaining" header="Sisa" sortable class="text-right">
                    <template #body="slotProps">
                        <div class="flex flex-col items-end gap-1">
                            <span class="font-black text-sm" :class="slotProps.data.isPaidOff ? 'text-surface-400  decoration-line-through' : ''">
                ...
                <template #expansion="slotProps">
                    <div class="p-4 bg-surface-50/50 border-y border-surface-200 ">
                        <div class="flex items-center gap-2 mb-3 ml-1">
                            ...
                            <h5 class="font-bold  text-xs uppercase tracking-wide">Riwayat Pembayaran Masuk</h5>
                        </div>
