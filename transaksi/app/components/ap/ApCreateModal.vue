    ...
    try {
        const payload = {
            details: {
                ...
                supplier: transaction.contactName, // Spesifik Hutang
                is_credit: 'true',
            }
        };
    ...
    >
        <template #header>
            <div class="flex items-center gap-3">
                <div class="w-8 h-8 rounded-full flex items-center justify-center text-white shadow-md bg-red-600 transition-colors duration-300">
                    <i class="pi pi-arrow-down-left"></i>
                </div>
                <div>
                    <span class="font-bold text-lg block">Catat Transaksi Hutang (AP)</span>
                    <span class="text-xs text-surface-500 font-normal">Pencatatan hutang usaha ke supplier/vendor</span>
                </div>
            </div>
        </template>
        ...
        <div class="flex flex-col h-full bg-surface-0 dark:bg-surface-900">
            <div class="p-6 space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="field">
                        <label class="font-semibold text-sm mb-1 block">Nama Supplier <span class="text-red-500">*</span></label>
                        <InputText 
                            v-model="transaction.contactName" 
                            placeholder="Nama Supplier / Pemberi Pinjaman"
                            class="w-full" 
                        />
                    </div>

                    <div class="field">
                        <label class="font-semibold text-sm mb-1 block">Jumlah Hutang <span class="text-red-500">*</span></label>
                        <InputNumber 
