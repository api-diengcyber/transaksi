        ...
        <div class="card-section">
            ...
            <div class="field">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    <div 
                        class="border rounded-xl p-4 cursor-pointer transition-all flex flex-col gap-3 relative overflow-hidden bg-surface-0 dark:bg-surface-100"
                    ...
                    >
                        <div class="h-20 w-full bg-surface-100 dark:bg-surface-100 rounded border border-surface-300 dark:border-surface-600 flex flex-col shadow-sm overflow-hidden">
                    ...
                    >
                        <div class="h-20 w-full bg-surface-100 dark:bg-surface-100 rounded border border-surface-300 dark:border-surface-600 flex shadow-sm overflow-hidden">
                    ...
                    >
                        ...
                        <div class="h-20 w-full bg-surface-100 dark:bg-surface-100 rounded border border-surface-300 dark:border-surface-600 flex shadow-sm overflow-hidden">
                            <div class="w-4 h-full bg-surface-200 dark:bg-surface-100 border-r border-surface-300 dark:border-surface-700 flex flex-col items-center pt-1 gap-1">
                                <div class="w-2 h-2 rounded bg-surface-800"></div>
                                <div class="w-2 h-2 rounded bg-surface-800"></div>
                            </div>
                            
                            <div class="flex-1 flex flex-col">
                                <div class="h-4 bg-surface-200 dark:bg-surface-100 border-b border-surface-300 dark:border-surface-700 flex items-end px-1 gap-1">
                                    <div class="h-3 w-5 bg-surface-300 dark:bg-surface-600 rounded-t-sm"></div>
                                    <div class="h-3 w-8 bg-surface-0 dark:bg-surface-100 rounded-t-sm border-t border-x border-surface-300 dark:border-surface-600 relative">
                                        <div class="absolute top-0 w-full h-0.5 bg-primary-500 rounded-t-sm"></div>
                                    </div>
                                    <div class="h-3 w-5 bg-surface-300 dark:bg-surface-600 rounded-t-sm"></div>
                                </div>
                                <div class="flex-1 p-2 bg-surface-0 dark:bg-surface-100">
                                    <div class="w-full h-1.5 bg-surface-100 dark:bg-surface-100 rounded mb-1"></div>
                                    <div class="w-1/2 h-1.5 bg-surface-100 dark:bg-surface-100 rounded"></div>
                                </div>
                            </div>
                        </div>
                        <div>
