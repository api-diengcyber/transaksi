        ...
        <div class="card-section">
            ...
            <div class="field">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                    ...
                    <div 
                        class="border rounded-xl p-4 cursor-pointer transition-all flex flex-col gap-3 relative overflow-hidden bg-surface-0"
                        :class="settings.layout_mode === 'topbar' ? 'border-primary-500 bg-primary-50 ring-1 ring-primary-500' : 'border-surface-200  hover:border-primary-300'"
                        @click="settings.layout_mode = 'topbar'"
                    >
                        <div class="h-20 w-full bg-surface-100 rounded border border-surface-300 flex flex-col shadow-sm overflow-hidden">
                            <div class="h-4 bg-primary-500 w-full"></div> 
                            <div class="flex-1 p-2 space-y-1">
                                <div class="w-1/2 h-1.5 bg-surface-200 rounded"></div>
                                <div class="w-3/4 h-1.5 bg-surface-200 rounded"></div>
                            </div>
                        </div>
                        <div>
                            <span class="font-bold text-sm block text-surface-900 ">Topbar</span>
                    ...
                    <div 
                        class="border rounded-xl p-4 cursor-pointer transition-all flex flex-col gap-3 relative overflow-hidden bg-surface-0"
                        :class="settings.layout_mode === 'sidebar' ? 'border-primary-500 bg-primary-50 ring-1 ring-primary-500' : 'border-surface-200  hover:border-primary-300'"
                        @click="settings.layout_mode = 'sidebar'"
                    >
                        <div class="h-20 w-full bg-surface-100 rounded border border-surface-300 flex shadow-sm overflow-hidden">
                            <div class="w-6 h-full bg-primary-500"></div> 
                            <div class="flex-1 p-2 space-y-1">
                                <div class="w-full h-1.5 bg-surface-200 rounded"></div>
                                <div class="w-2/3 h-1.5 bg-surface-200 rounded"></div>
                            </div>
                        </div>
                        <div>
                            <span class="font-bold text-sm block text-surface-900 ">Sidebar</span>
                    ...
                    <div 
                        class="border rounded-xl p-4 cursor-pointer transition-all flex flex-col gap-3 relative overflow-hidden bg-surface-0"
                        :class="settings.layout_mode === 'tabs' ? 'border-primary-500 bg-primary-50 ring-1 ring-primary-500' : 'border-surface-200  hover:border-primary-300'"
                    ...
                    >
                        <div class="h-20 w-full bg-surface-100 rounded border border-surface-300 flex flex-col shadow-sm overflow-hidden">
                            ...
                            <div class="h-4 bg-primary-500 w-full flex justify-around items-center px-2"> 
                                <div class="w-2 h-2 rounded-full bg-surface-0/50"></div>
                                <div class="w-2 h-2 rounded-full bg-surface-0/50"></div>
                                <div class="w-2 h-2 rounded-full bg-surface-0/50"></div>
                            </div>
                        </div>
                        <div>
                            <span class="font-bold text-sm block text-surface-900 ">Bottom Nav</span>
                    ...
                    <div 
                        class="border rounded-xl p-4 cursor-pointer transition-all flex flex-col gap-3 relative overflow-hidden bg-surface-0"
                        :class="settings.layout_mode === 'multiwindow' ? 'border-primary-500 bg-primary-50 ring-1 ring-primary-500' : 'border-surface-200  hover:border-primary-300'"
                        @click="settings.layout_mode = 'multiwindow'"
                    >
                        
                        <div class="h-20 w-full bg-surface-100 rounded border border-surface-300 flex shadow-sm overflow-hidden">
                            <div class="w-4 h-full bg-surface-200 border-r border-surface-300 flex flex-col items-center pt-1 gap-1">
                                <div class="w-2 h-2 rounded bg-surface-800"></div>
                                <div class="w-2 h-2 rounded bg-surface-800"></div>
                            </div>
                            
                            <div class="flex-1 flex flex-col">
                                <div class="h-4 bg-surface-200 border-b border-surface-300 flex items-end px-1 gap-1">
                                    <div class="h-3 w-5 bg-surface-300 rounded-t-sm"></div>
                                    <div class="h-3 w-8 bg-surface-0 rounded-t-sm border-t border-x border-surface-300 relative">
                                        <div class="absolute top-0 w-full h-0.5 bg-primary-500 rounded-t-sm"></div>
                                    </div>
                                    <div class="h-3 w-5 bg-surface-300 rounded-t-sm"></div>
                                </div>
                                <div class="flex-1 p-2 bg-surface-0">
                                    <div class="w-full h-1.5 bg-surface-100 rounded mb-1"></div>
                                    <div class="w-1/2 h-1.5 bg-surface-100 rounded"></div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <span class="font-bold text-sm block text-surface-900 ">Multi-Window</span>
