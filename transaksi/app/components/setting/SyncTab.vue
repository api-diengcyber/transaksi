    ...
    <div class="animate-fade-in space-y-6">
        <div class="card-section">
            ...
            <div class="flex flex-col gap-6">
                <div class="flex items-center justify-between p-4 rounded-lg border border-surface-100  bg-surface-50/50">
                    <div class="flex gap-4 items-center">
                        <div class="w-10 h-10 rounded-full bg-surface-0 flex items-center justify-center shadow-sm text-primary-600 shrink-0">
                            <i class="pi pi-sync text-lg"></i>
                        </div>
                        <div>
                            <label class="text-sm font-bold  block">Aktifkan Sinkronisasi</label>
                ...
                <div v-if="props.settings.sync_enabled" class="space-y-6 animate-fade-in">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                            ...
                            <div @click="!loading && (props.settings.sync_mode = 'automatic')"
                                 ...
                                 :class="props.settings.sync_mode === 'automatic' 
                                    ...
                                    : 'border-surface-200  hover:border-primary-200 bg-surface-0'">
                                ...
                                <div>
                                    <span class="block text-sm font-bold mb-1" :class="props.settings.sync_mode === 'automatic' ? 'text-primary-700 ' : ''">
                            ...
                            <div @click="!loading && (props.settings.sync_mode = 'manual')"
                                ...
                                <div>
                                    <span class="block text-sm font-bold mb-1" :class="props.settings.sync_mode === 'manual' ? 'text-primary-700 ' : ''">
                    ...
                    <div v-if="props.settings.sync_mode === 'manual'" class="field animate-fade-in bg-surface-50/50 p-4 rounded-lg border border-surface-200 ">
                        <label>URL Endpoint Server</label>
                        <div class="p-inputgroup mt-1">
                            <span class="p-inputgroup-addon bg-surface-0 text-surface-500">
                                <i class="pi pi-link text-sm"></i>
                            </span>
                            <span class="p-inputgroup-addon bg-surface-0 text-surface-600 font-mono text-xs"></span>
...
.section-title { @apply text-base font-bold  mb-6 pb-2 border-b border-surface-100 ; }
