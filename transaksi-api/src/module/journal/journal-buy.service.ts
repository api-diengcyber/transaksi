...
export class JournalBuyService {
  ...
  async createBuy(details: any, userId: string, storeUuid: string, externalManager?: EntityManager) {
    ...
    const work = async (manager: EntityManager) => {
        ...
        return { message: 'BUY journal created', journal, details: detailEntities };
    };
