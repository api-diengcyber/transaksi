  ...
  async installStore(dto: InstallStoreDto, logoPath: string | null = null, originalName: string | null = null) {
    ...
    return await this.dataSource.transaction(async (manager) => {
      ...
      const defaultSettingsConfig: Record<string, any> = {
        ...
        purchase_invoice_number_type: 'numeric',
        purchase_invoice_prefix: 'BUY-',
        purchase_invoice_length: '5',
        purchase_invoice_suffix: '-INV',
        ar_invoice_number_type: 'numeric',
        ar_invoice_prefix: 'AR-',
        ar_invoice_length: '5',
        ar_invoice_suffix: '-INV',
        ap_invoice_number_type: 'numeric',
        ap_invoice_prefix: 'AP-',
        ap_invoice_length: '5',
        ap_invoice_suffix: '-INV'
      };
